...
lemma equiv_comm_append_of_indep_symb
    {w : List α} {a : α} [DecidableEq α] (h : independent I [a] w) :
...
instance traceSetoid (I : Independence α) : Setoid (List α) where
  r := TraceEquiv I
...
lemma equiv_comm_append_of_indep {w₁ w₂ : List α} [DecidableEq α] (h : independent I w₁ w₂) :
