...
def dependencyIn (t : Trace I) (a b : {a : α // a ∈ t}) :=
  (inducedDependence I).rel a b

def dependencyTransClosureIn (t : Trace I) (a b : {a : α // a ∈ t}) :=
...
def connectedComponents (X : Set (Trace I)) : Set (Trace I) :=
  {u | IsConnected I u ∧ u ≠ 1 ∧ ∃ v, u * v ∈ X ∧ Independent' u v}
...
lemma append_indep_is_disconnected_chars {u v : Trace I}
    (huv : Independent' u v) (a b : { a // a ∈ u * v }) (ha : a.1 ∈ u) (hb : b.1 ∈ v) :
...
lemma append_indep_is_disconnected
    (u v : Trace I) (h : Independent' u v) (hu : u ≠ 1) (hv : v ≠ 1) :
  ...
  have h_ab_dis :=
    append_indep_is_disconnected_chars
      h
      ⟨a, mem_append.mpr (Or.inl ha)⟩
      ⟨b, mem_append.mpr (Or.inr hb)⟩
      ha
      hb
